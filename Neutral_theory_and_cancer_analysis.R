###
# Analyses for the manuscript: Neutral theory and the somatic evolution of cancer
...
# Verifying that we obtain the same results from McLachlan and Kimura from the raw data 
...
# remove data from variants not in coding sequence 
...
# load data on all possible trinucleotide contexts in the genome and their frequencies
...
# help with the scaling from https://github.com/tidyverse/ggplot2/issues/980
...
# function to create different density plots, unstacked ---- 
...
SKCMM_density <- density_plotter_function(main_df = combined_all_data.noNA,
                                          ...
                                          sub_1_lab_y = .2,
                                          sub_1_lab_x = 2e6,
                                          sub_1_arrow_x =   6814601.59,
                                          sub_1_arrow_y = 0.05,
                                          sub_2_lab_y = .1,
                                          sub_2_lab_x = 1e6,
                                          sub_2_arrow_x =    5676420.55,
                                          sub_2_arrow_y = .02,
